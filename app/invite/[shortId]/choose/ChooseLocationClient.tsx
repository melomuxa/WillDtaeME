          ...
          return (
            ...
            >
              ...
              {opt.imageUrl ? (
                ...
                <div className="w-full h-28 bg-gradient-to-br from-pink-100 to-rose-100 rounded-xl mb-3 flex items-center justify-center text-5xl">
                  {icon}
                </div>
              )}
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                {opt.category && (
                  <span className="text-xs bg-pink-50 text-pink-600 px-2 py-0.5 rounded-full shrink-0 flex items-center gap-1">
                    <span>{icon}</span>
                    <span>{opt.category.replace(/^\p{Emoji}\s*/u, '')}</span>
                  </span>
                )}
              </div>

    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-pink-50 via-white to-rose-50 px-6 relative overflow-hidden">
      ...
      <div className="text-center max-w-md relative z-10">
        ...
        <div className="flex items-center justify-center gap-6">
          {/* Yes button — primary, pulsing, easy to click */}
          <button
            onClick={handleYes}
            className="bg-pink-500 hover:bg-pink-600 text-white font-bold text-xl px-10 py-4 rounded-full shadow-lg shadow-pink-200 transition-all animate-pulse hover:animate-none hover:scale-105 active:scale-95"
          >
            YES ✨
          </button>

          {/* No button — flees the cursor on desktop, hidden on mobile */}
          <FleeingNoButton />
        </div>
      </div>
    </main>
